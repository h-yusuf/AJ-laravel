...
<body class="bg-gray-50">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                ...
                                                United States</td>
                                            <td
                                                class="p-4 text-base font-normal text-gray-900 whitespace-nowrap lg:p-5">
                                                <div class="flex items-center">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/roberta-casas.png"
                                                    alt="Roberta Casas avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                                    <div class="text-base font-semibold text-gray-900">Roberta Casas
                                                    </div>
                                                    <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/michael-gough.png"
                                                    alt="Michael Gough avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                                    <div class="text-base font-semibold text-gray-900">Michael Gough
                                                    </div>
                                                    <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/jese-leos.png"
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/bonnie-green.png"
                                                    alt="Bonnie Green avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                                    <div class="text-base font-semibold text-gray-900">Bonnie Green
                                                    </div>
                                                    <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/thomas-lean.png"
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/helene-engels.png"
                                                    alt="Helene Engels avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                                    <div class="text-base font-semibold text-gray-900">Helene Engels
                                                    </div>
                                                    <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/lana-byrd.png"
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/leslie-livingston.png"
                                                    alt="Leslie Livingston avatar">
                                                <div class="text-sm font-normal text-gray-500">
                                                    <div class="text-base font-semibold text-gray-900">Leslie Livingston
                                                    </div>
                                                    <div class="text-sm font-normal text-gray-500">
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td
                                                class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap lg:p-5 lg:mr-0">
                                                <img class="w-8 h-8 rounded"
                                                    src="https://demos.creative-tim.com/soft-ui-flowbite/images/users/robert-brown.png"
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"84039ed65d185f3b","version":"2023.10.0","token":"1b7cbb72744b40c580f8633c6b62637e"}'
