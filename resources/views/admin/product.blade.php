                    ...
                    <div class="flex-1 px-3 bg-gray-50" id="sidebar-items">
                        <ul class="pb-2 pt-1">
                            ...
                            <a href="user"
                                ...
                                sidebar-toggle-collapse="">
                                <div
                                    class="bg-white shadow-lg shadow-gray-300   w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                                                        ...
                                                        <div class="relative bg-white rounded-2xl shadow-lg">
                                                            ...
                                                            <div class="p-6 space-y-6">
                                                                <form action="{{ route('tambahJasa') }}"
                                                                    ...
                                                                    <div
                                                                        class="p-6 rounded-b border-t border-gray-200">
                                                                        <button
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($datajasa as $item)
                                            <tr class="hover:bg-gray-100">
                                                ...
                                                <td
                                                    class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                                                    <img width="70px" src="{{ $item->img_jasa }}" alt="">
                                                </td>
                                                <td
                                                ...
                                                <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                                    ...
                                                    <form class="inline-flex items-center"
                                                        ...
                                                        @csrf
                                                        <input type="hidden" name="item_id_rm"
                                                            value="{{ $item->idJasa }}">
                                                        <button type="submit"
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="#"
                            ...
                            <svg class="mr-1 -ml-1 w-5 h-5" " fill=" currentColor" viewBox="0 0 20 20"
                                ...
                                1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                            </svg>
                            Previous
                        </a>
                        <a href="#"
