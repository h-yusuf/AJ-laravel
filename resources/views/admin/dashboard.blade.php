...
<head>
    ...
    <meta name="twitter:title" content="Soft UI Flowbite">
    <meta name="twitter:description"
        content="Get started with a free dashboard template featuring hundreds of UI components and pages based on the Soft UI Design System, Flowbite, and Tailwind CSS">
    <meta name="twitter:image" content="https://demos.creative-tim.com/soft-ui-flowbite/">

    <meta property="og:url" content="https://demos.creative-tim.com/soft-ui-flowbite/">
    <meta property="og:title" content="Soft UI Flowbite">
...
<body class="bg-gray-50">
                        ...
                        <div class="flex justify-start items-center">
                            ...
                            <a href="https://demos.creative-tim.com/soft-ui-flowbite/"
                                ...
                                <img src="/icon/Ada jasa blue.png" class="mr-4 h-8" style="margin-left: 30px"
                                    >
                                <span  class="hidden md:inline-block  self-center font-semibold text-base whitespace-nowrap">Admin </span>
                            </a>
                ...
                <div class="flex overflow-y-auto flex-col flex-1 pt-8 pb-4">
                    <div class="flex-1 px-3 bg-gray-50" id="sidebar-items">
                        <ul class="pb-2 pt-1">
                            ...
                            <li>
                                <a href="dashboard"
                                class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg bg-white shadow-lg shadow-gray-200 hover:!bg-white  group transition-all duration-200"
        ...
        <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
            <main>
                <div class="px-4 pt-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 mb-6 w-full xl:grid-cols-2 2xl:grid-cols-3">
                        <div
                            ...
                            <div class="flex justify-between items-center mb-4">
                                <div class="flex-shrink-0">
                                    <span class="text-2xl font-bold leading-none text-white sm:text-3xl">$45,385</span>
                                    <h3 class="text-base font-normal text-gray-400">Sales this week</h3>
                                </div>
                                <div class="flex flex-1 justify-end items-center text-base font-bold text-green-500">
                                    12.5%
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                            ...
                            <div class="flex justify-between items-center pt-3 mt-5 border-t border-gray-700 sm:pt-6">
                                <div>
                                    <button
                                    ...
                                    <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg shadow-gray-200"
                        ...
                        <div class="bg-white shadow-lg shadow-gray-200 rounded-2xl p-4 ">
                            ...
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="#"
                                        class="p-2 text-sm font-medium text-gray-900 rounded-lg hover:bg-gray-100">View
                                        all</a>
                                </div>
                            </div>
                                                ...
                                                <tbody class="divide-y divide-gray-200">
                                                    <tr>
                                                        <td
                                                            ...
                                                            <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <rect y="0.529053" width="25.7522" height="17.1429"
                                                                    rx="2" fill="white" />
                                                                ...
                                                                <g mask="url(#mask0)">
                                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                                        ...
                                                                        fill="#D02F44" />
                                                                    <rect y="0.529053" width="11.0367" height="8"
                                                                        fill="#46467F" />
                                                                    <g filter="url(#filter0_d)">
                                                                        ...
                                                                        <defs>
                                                                            <filter id="filter0_d" x="1.22607"
                                                                                y="1.67188" width="8.58408"
                                                                                height="6.71428"
                                                                            ...
                                                                            <linearGradient id="paint0_linear"
                                                                                x1="1.22607" y1="1.67188" x2="1.22607"
                                                                                y2="7.38616"
                                                            ...
                                                            <span
                                                                class="mx-5 ml-3 w-32 text-base font-medium text-gray-900 sm:flex-none">United
                                                                States</span>
                                                        </td>
                                                        <td
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <rect x="0.25" y="0.779053" width="25.2567"
                                                                    height="16.6429" rx="1.75" fill="white"
                                                                ...
                                                                <g mask="url(#mask0)">
                                                                    <rect x="18.3975" y="0.529053" width="7.35907"
                                                                        height="17.1429" fill="#FF3131" />
                                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            <span
                                                                class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900">Canada</span>
                                                        </td>
                                                        <td
                                                            class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap">
                                                            8340
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none"
                                                                ...
                                                                <g mask="url(#mask0)">
                                                                    <rect x="17.1714" y="0.529053" width="8.58558"
                                                                        height="17.1429" fill="#F44653" />
                                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            <span
                                                                class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900">France</span>
                                                        </td>
                                                        <td
                                                            class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap">
                                                            6700
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <rect y="0.529053" width="25.7567" height="17.1429"
                                                                    rx="2" fill="white" />
                                                                <mask id="mask0" style="mask-type: alpha"
                                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="26"
                                                                    height="18">
                                                                ...
                                                                <g mask="url(#mask0)">
                                                                    ...
                                                                    <defs>
                                                                        <linearGradient id="paint0_linear" x1="0"
                                                                            y1="0.529053" x2="0" y2="9.10048"
                                                                            gradientUnits="userSpaceOnUse">
                                                                            <stop stop-color="white" />
                                                                            <stop offset="1" stop-color="#F0F0F0" />
                                                                        </linearGradient>
                                                                        <linearGradient id="paint1_linear" x1="0"
                                                                            y1="0.529053" x2="0" y2="8.52905"
                                                                            gradientUnits="userSpaceOnUse">
                                                            ...
                                                            <span
                                                                class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900">Australia</span>
                                                        </td>
                                                        <td
                                                            class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap">
                                                            3900
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <rect x="0.25" y="0.779297" width="25.2522"
                                                                    height="16.6429" rx="1.75" fill="white"
                                                                    stroke="#F3F4F6" stroke-width="0.5" />
                                                                <mask id="mask0" style="mask-type: alpha"
                                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="26"
                                                                ...
                                                                <g mask="url(#mask0)">
                                                                    <rect x="17.168" y="0.529297" width="8.58408"
                                                                        height="17.1429" fill="#E43D4C" />
                                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            <span
                                                                class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900">Italy</span>
                                                        </td>
                                                        <td
                                                            class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap">
                                                            2470
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none"
                                                                ...
                                                                <g mask="url(#mask0)">
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        fill="#181A93" fill-opacity="0.15"
                                                                        stroke="#181A93" stroke-width="0.666667" />
                                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            <span
                                                                class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900">India</span>
                                                        </td>
                                                        <td
                                                            class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap">
                                                            700
                                                    ...
                                                    <tr>
                                                        <td
                                                            class="flex items-center p-4 text-sm font-normal text-gray-900 whitespace-nowrap">
                                                            <svg class="w-4 h-4" viewBox="0 0 28 20" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <rect x="0.25" y="0.25" width="27.5" height="19.5"
                                                                    rx="1.75" fill="white" stroke="#F5F5F5"
                                                                    stroke-width="0.5" />
                                                                <mask id="mask0_267_1444" style="mask-type: alpha"
                                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="28"
                                                                    height="20">
                                                                    <rect x="0.25" y="0.25" width="27.5" height="19.5"
                                                                        rx="1.75" fill="white" stroke="white"
                                                                        stroke-width="0.5" />
                                                                </mask>
                                                                <g mask="url(#mask0_267_1444)">
                                                                    ...
                                                                    <defs>
                                                                        <linearGradient id="paint0_linear_267_1444"
                                                            ...
                                                            <span
                                                                class="flex-none mx-5 ml-3 w-32 text-base font-medium text-gray-900">Japan</span>
                                                        </td>
                                                        <td
                                                            class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap">
                                                            300
            ...
            <footer
                ...
                <ul class="flex flex-wrap items-center mb-6 md:mb-0">
                    <li>
                        <a href="#" class="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6">Terms and
                            conditions</a>
                    </li>
                    <li>
                        <a href="#" class="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6">Privacy
                            Policy</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#" class="mr-4 text-sm font-normal text-gray-500 hover:underline md:mr-6">Cookie
                            Policy</a>
                    </li>
                    <li>
            ...
            <p class="my-10 text-sm text-center text-gray-500">
                &copy; 2019-2022 Built with ❤️ by
                <a href="https://creative-tim.com" class="hover:underline" target="_blank">Creative Tim</a>
                and
                <a href="https://flowbite.com" class="hover:underline" target="_blank">Flowbite</a>. All rights
                reserved.
            </p>
        </div>
    </div>
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"840396414e9c893c","version":"2023.10.0","token":"1b7cbb72744b40c580f8633c6b62637e"}'
